...
en_file = "/home/pena/Downloads/Tema_9_-_ESPERANÇA2024-12-06_16_56_37-1 PTBR-ENv2.docx"
...
en_file_diff = "/home/pena/Downloads/Tema_9_-_ESPERANÇA2024-12-06_16_56_37-1_PTBR-ENv2_DIFF.docx"
...
with open(diff_report_path, "w", encoding="utf-8") as report:
    ...
    if differences:
        ...
        for diff_number, diff_index, pt_entry, en_entry, translated_line, similarity in differences:
            ...
            # Modificar o arquivo de inglês
            for para in doc_en.paragraphs:
                if para.text == en_text:
                    # Adicionar o texto com a sugestão de correção logo após o texto original
                    para.add_run(f"\n\n[SUGESTÃO]\n{translated_line}")
